               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="blog-post">
                           <div class="blog-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/blog/bg1-1.jpg" alt=""> </div>
                           <div class="post-txt">
                              <h5><a href="#">How you can keep alive wild animals for long.</a></h5>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="blog-post">
                           <div class="blog-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/blog/bg1-2.jpg" alt=""> </div>
                           <div class="post-txt">
                              <h5><a href="#">In eu lorem a ante mattis vehicula ac in nunc.</a></h5>
                              <p>According to a survey the perceived higher cost of environmentally-friendly products is the major holdup to consumers going green.</p>
                           </div>
                           <ul class="post-meta">
                              <li> <a href="#"><i class="fas fa-calendar-alt"></i> 29 September, 2018</a> </li>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="blog-post">
                           <div class="blog-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/blog/bg1-3.jpg" alt=""> </div>
                           <div class="post-txt">
                              <h5><a href="#">Sed ut tellus vel quam molestie feugiat.</a></h5>
                              <p>According to a survey the perceived higher cost of environmentally-friendly products is the major holdup to consumers going green.</p>
                           </div>
                           <ul class="post-meta">
                              <li> <a href="#"><i class="fas fa-calendar-alt"></i> 29 September, 2018</a> </li>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="blog-post">
                           <div class="blog-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/blog/bg1-4.jpg" alt=""> </div>
                           <div class="post-txt">
                              <h5><a href="#">Nulla pretium eros ultricies rhoncus tempus.</a></h5>
                              <p>According to a survey the perceived higher cost of environmentally-friendly products is the major holdup to consumers going green.</p>
                           </div>
                           <ul class="post-meta">
                              <li> <a href="#"><i class="fas fa-calendar-alt"></i> 29 September, 2018</a> </li>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="blog-post">
                           <div class="blog-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/blog/bg1-5.jpg" alt=""> </div>
                           <div class="post-txt">
                              <h5><a href="#">Maecenas quis est eget leo blandit finibus.</a></h5>
                              <p>According to a survey the perceived higher cost of environmentally-friendly products is the major holdup to consumers going green.</p>
                           </div>
                           <ul class="post-meta">
                              <li> <a href="#"><i class="fas fa-calendar-alt"></i> 29 September, 2018</a> </li>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="blog-post">
                           <div class="blog-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/blog/bg1-6.jpg" alt=""> </div>
                           <div class="post-txt">
                              <h5><a href="#">Nunc venenatis mauris sed tristique fringilla.</a></h5>
                              <p>According to a survey the perceived higher cost of environmentally-friendly products is the major holdup to consumers going green.</p>
                           </div>
                           <ul class="post-meta">
                              <li> <a href="#"><i class="fas fa-calendar-alt"></i> 29 September, 2018</a> </li>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="blog-post">
                           <div class="blog-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/blog/bg1-7.jpg" alt=""> </div>
                           <div class="post-txt">
                              <h5><a href="#">Fusce porttitor ex quis viverra interdum.</a></h5>
                              <p>According to a survey the perceived higher cost of environmentally-friendly products is the major holdup to consumers going green.</p>
                           </div>
                           <ul class="post-meta">
                              <li> <a href="#"><i class="fas fa-calendar-alt"></i> 29 September, 2018</a> </li>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="blog-post">
                           <div class="blog-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/blog/bg1-8.jpg" alt=""> </div>
                           <div class="post-txt">
                              <h5><a href="#">Sed dapibus dui vehicula neque varius finibus.</a></h5>
                              <p>According to a survey the perceived higher cost of environmentally-friendly products is the major holdup to consumers going green.</p>
                           </div>
                           <ul class="post-meta">
                              <li> <a href="#"><i class="fas fa-calendar-alt"></i> 29 September, 2018</a> </li>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="blog-post">
                           <div class="blog-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/blog/bg1-9.jpg" alt=""> </div>
                           <div class="post-txt">
                              <h5><a href="#">How you can keep alive wild animals for long.</a></h5>
                              <p>According to a survey the perceived higher cost of environmentally-friendly products is the major holdup to consumers going green.</p>
                           </div>
